...
$("#G").click(() => {
  ...
  //random numbers
  let insult1=Math.floor(Math.random()*insultsV1.length);
  let insult2=Math.floor(Math.random()*insultsV2.length);
  let insult3=Math.floor(Math.random()*insultsV2.length);
